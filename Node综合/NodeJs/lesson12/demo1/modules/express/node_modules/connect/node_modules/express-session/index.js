 ...
 *  are typically fine. For example below is a user-specific html counter:
 *
 *       connect()
 *         .use(connect.favicon())
 *         .use(connect.cookieParser())
 ...
 *    - `.clear(callback)`
 *
 * For an example implementation html the [connect-redis](http://github.com/visionmedia/connect-redis) repo.
 *
